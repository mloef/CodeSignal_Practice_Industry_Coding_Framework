...
class TestLevel1(unittest.TestCase):
    ...
    def test_get_task_not_found(self):
        ...
        """
        self.mgr.add_task("Task1", "Description1")
        result = self.mgr.get_task("Task2")
        self.assertEqual(result, "error: task not found")

    def test_get_task_not_found_empty(self):
        """
        Test that get_task returns an error message if there are no tasks.
        """
        result = self.mgr.get_task("Task1")
        self.assertEqual(result, "error: task not found")
...
class TestLevel2(TestLevel1):
    ...
    def test_update_task_invalid_data(self):
        ...
        """
        self.mgr.add_task("Task1", "Description1")
        result = self.mgr.update_task("Task1", "", "Description2")
        self.assertEqual(result, "error: invalid task data")
    
        result = self.mgr.update_task("Task1", "Task2", "")
        self.assertEqual(result, "error: invalid task data")
    ...
    def test_update_task_not_found(self):
        ...
        """
        self.mgr.add_task("Task1", "Description1")
        result = self.mgr.update_task("Task2", "Task3", "Description3")
        self.assertEqual(result, "error: task not found")
...
class TestLevel3(unittest.TestCase):
    ...
    def test_add_task_invalid_data(self):
        ...
        """
        result = self.mgr.add_task_by_id("", "No title")
        self.assertEqual(result, "error: invalid task data")

        result = self.mgr.add_task_by_id("No desc", "")
        self.assertEqual(result, "error: invalid task data")
    ...
    def test_update_task_by_id_not_found(self):
        ...
        self.mgr.add_task_by_id("A", "B")
        result = self.mgr.update_task_by_id(999, "Title", "Desc")
        self.assertEqual(result, "error: task not found")
    ...
    def test_update_task_by_id_invalid_data(self):
        ...
        If new_title or new_description is empty => "error: invalid task data"
        """
        self.mgr.add_task_by_id("Task1", "Desc1")  # id 1
        result = self.mgr.update_task_by_id(1, "", "NewDesc")
        self.assertEqual(result, "error: invalid task data")

        result = self.mgr.update_task_by_id(1, "NewTitle", "")
        self.assertEqual(result, "error: invalid task data")
    ...
    def test_update_task_by_id_success(self):
        ...
        """
        self.mgr.add_task_by_id("Task1", "Desc1")  # id 1
        result = self.mgr.add_task_by_id("Task2", "Desc2")  # id 2
        id = int(result.split("id: ")[1])
        result = self.mgr.update_task_by_id(id, "Task2_new", "Desc2_new")
        self.assertEqual(result, f"task updated: {id}")
        self.assertEqual(self.mgr.get_task_by_id(id), "Task2_new, Desc2_new")

    def test_delete_task_by_id_not_found(self):
        """
        If no task with the given ID => "error: task not found"
        """
        self.mgr.add_task_by_id("X", "Y")  # id=1
        result = self.mgr.delete_task_by_id(999)
        self.assertEqual(result, "error: task not found")
    ...
    def test_delete_task_by_id_success(self):
        ...
        result = self.mgr.delete_task_by_id(id1)
        self.assertEqual(result, f"task deleted: {id1}")
        self.assertEqual(self.mgr.list_tasks(), "[T2]")
        self.assertEqual(self.mgr.get_task_by_id(id2), "T2, D2")
    ...
    def test_get_task_by_id_found(self):
        ...
        id = int(result.split("id: ")[1])
        result = self.mgr.get_task_by_id(id)
    ...
    def test_get_task_by_id_not_found(self):
        ...
        """
        result = self.mgr.get_task_by_id(999)
        self.assertEqual(result, "error: task not found")
    ...
    def test_get_task_by_id_duplicate_titles(self):
        ...
        result = self.mgr.add_task_by_id("TaskA", "Second description")
        id = int(result.split("id: ")[1])
        result = self.mgr.get_task_by_id(id)
...
class TestLevel4(unittest.TestCase):
    ...
    Adds:
      ...
      - (Revised) get_task_by_id optionally returns priority
    """
    ...
    def test_add_task_by_id_due_date(self):
        ...
        result2 = self.mgr.add_task_by_id("TaskInvalidDate", "Desc", "invalid-date")
